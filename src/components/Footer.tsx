      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                ...
                Join thousands of businesses that trust ADmyBRAND AI Suite.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300"
                >
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-purple-500 transition-colors duration-300"
              ...
              <ul className="space-y-3">
                {links.map((link, linkIndex) => (
                  <motion.li
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.3, delay: 0.2 + categoryIndex * 0.1 + linkIndex * 0.05 }}
                  >
                    <a
                      href={link.href}
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-400">support@admybrand.com</span>
            </div>
            <div className="flex items-center gap-3">
        ...
        >
          <p className="text-gray-400">
            © 2024 ADmyBRAND AI Suite. All rights reserved. Made with{' '}
